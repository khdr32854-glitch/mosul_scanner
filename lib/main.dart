  ...
  void _autoCropActiveItem() {
    ...
    if (result.changed) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('لم يتم اكتشاف حدود مستند'), backgroundColor: Colors.orange),
      );
    }
  }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ...
          IconButton(icon: const Icon(Icons.document_scanner, size: 22, color: Color(0xFF4ADE80)), tooltip: 'مسح Google', onPressed: _googleScan),
...
// ================= =================
// شاشة القص اليدوي وتصحيح المنظور
// ================= =================
