...
class _MainScannerScreenState extends State<MainScannerScreen> {
  ...
  void _addNewImages(ImageSource source) async {
    ...
    for (int i = 0; i < pickedFiles.length; i++) {
      ...
      if (decodedImg != null) {
        ...
        final encodedBytes = Uint8List.fromList(img.encodeJpg(autoCropped, quality: 85));
        ...
        setState(() {
          final newItem = DocumentItem(
            ...
            heightMm: _currentMode == 'photos' ? 45 : (autoCropped.height / autoCropped.width * 85),
  ...
  img.Image _autoDetectAndCrop(img.Image src) {
    ...
    if (cropW > 50 && cropH > 50) {
      return img.copyCrop(src, x: marginX, y: marginY, width: cropW, height: cropH);
    }
    return src;
  }
